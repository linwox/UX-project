      ...
      <div class="flex flex-col md:flex-row items-center justify-center">
        ...
        <div class="bg-stone-300 p-4 rounded-xl w-72 h-52">
          <div class="m-3">
            <h3 class="text-lg font-semibold">Citat-spelet:</h3>
            <p class="text-sm">
              * Ett citat visas från en<br />slumpmässig ledamot.<br />* Välj citat som du vibear<br />med
              mest. Alla citat är<br />slumpmässigt utvalda, välj det<br />som känns bäst.
            </p>
          </div>
        </div>
